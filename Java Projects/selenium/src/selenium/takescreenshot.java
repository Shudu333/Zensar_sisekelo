...
public class takescreenshot {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            FileUtils.copyFile(screenshot1, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"1.png")); // Copy the file to a location and use 
            ...
            FileUtils.copyFile(screenshot2, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"2.png")); // Copy the file to a location and use 
           ...
           FileUtils.copyFile(screenshot3, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"3.png")); //Copy the file to a location and use 
           ...
           driver.findElement(By.xpath("//*[@id=\""+text+"\"]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div[2]/div/div/div/div[3]/div/div[1]/div/div/div/div/div[3]/div/div[2]/div[2]/div")).click();     
           Thread.sleep(1000); // click home icon to load news feed
           File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE); //take screenshot of Dashboard page
           FileUtils.copyFile(screenshot4, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"4.png")); //Copy the file to a location and use 
           ...
           FileUtils.copyFile(screenshot5, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"5.png")); //Copy the file to a location and use 
           
           driver.findElement(By.xpath("//*[@id=\""+text+"\"]/div/div[1]/div/div[4]/div/div/div[1]/div/div[2]/div/div/div/form/div/div[1]/div/div/div/div[2]/div[1]/div[1]/div[1]/div/div/div/div/div/div/div[2]/div/div/div/div")).sendKeys("Hello im a new user",Keys.ENTER);
           ...
           FileUtils.copyFile(screenshot6, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"6.png")); //Copy the file to a location and use 
           ...
           FileUtils.copyFile(screenshot7, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"7.png")); //Copy the file to a location and use
           ...
           FileUtils.copyFile(screenshot8, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"8.png")); //Copy the file to a location and use
           ...
           FileUtils.copyFile(screenshot9, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"9.png")); //Copy the file to a location and use
...
//           Thread.sleep(5000);
          ...
          //Take the screenshot
           File screenshot10 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE); // Take Screenshot of search data
            FileUtils.copyFile(screenshot10, new File("C:\\Users\\Ndou\\Desktop\\sc\\"+newFile+"10.png"));
...
//            
            ...
            System.out.println("* Add friend                 Pass *");
            System.out.println("* Screenshot 11              Pass *");
            System.out.println("***********************************");
