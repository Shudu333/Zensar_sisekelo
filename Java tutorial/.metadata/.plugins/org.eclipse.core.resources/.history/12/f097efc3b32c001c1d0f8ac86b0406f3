...
public class GmailPageObjects {
	...
	@FindBy(how=How.XPATH, xpath="//*[@id=\"user\"]")
	WebElement emailField;
	
	@FindBy(how=How.XPATH, xpath="//*[@id=\"pass\"]")
	WebElement passwordField;
	
	@FindBy(how=How.XPATH, xpath="//span[@class='msgicon status']") ////*[@id="gb"]/div[2]/div[1]/div[4]/div/a/img
